...
import 'package:gulferp/screen/reports/report.dart';
import 'package:gulferp/screen/reports/settlementReport.dart';
                              ...
                              ListTile(
                                onTap: () {
                                  ...
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => SettlementReport(
                                            // reportType: "3",
                                            )),
                                  );
                                },
                            ...
                            Navigator.of(context).push(
                              PageRouteBuilder(
                                  ...
                                  pageBuilder: (_, __, ___) => Collection(
                                      form_type: "5", type: "Collection")
                                  // OrderForm(widget.areaname,"return"),
                                  ),
                            );
                          },
                          leading: Image.asset("asset/selfcollect.png",
                              // color: Colors.red,
                              height: 30),
                          trailing: Icon(
                            Icons.arrow_forward,
                            ...
                            Navigator.of(context).push(
                              PageRouteBuilder(
                                  ...
                                  pageBuilder: (_, __, ___) =>
                                      Expense(form_type: "4", type: "Expense")
                                  // OrderForm(widget.areaname,"return"),
                                  ),
                            );
                          },
